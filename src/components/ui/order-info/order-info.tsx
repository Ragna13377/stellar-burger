...
export const OrderInfoUI: FC<OrderInfoUIProps & { isDirect: boolean }> = memo(
  ({ orderInfo, isDirect }) => (
    <div
      className={clsx(styles.wrap, {
        [styles.directLink]: isDirect
      })}
    >
      {isDirect && (
        <h2 className='text text_type_main-large'>#{orderInfo.number}</h2>
      )}
